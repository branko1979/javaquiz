...
public class UserService implements UserDetailsService {
	...
	public List<Quizuser> findAll() {
		...
		for (Quizuser user : userRepository.findAll()) {
			users.add(user);
	...
	public List<Quizuser> findAllParticipants() {
		List<Quizuser> participants = new ArrayList<>();
		for (Quizuser user : userRepository.findAll()) {
	...
	public List<Quizuser> findUsersWithCorrectAnswers(){
		return userRepository.findUsersWithCorrectAnswers();
	}
	
	public List<Quizuser> findUsersWithAllAnswers(){
