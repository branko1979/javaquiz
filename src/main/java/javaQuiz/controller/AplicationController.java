...
public class AplicationController {
	...
	public String saveUser(@ModelAttribute Quizuser user, BindingResult bindingResult, HttpServletRequest request) {
	...
	public String submitAnswers(@RequestParam("nextQuestionId") int questionSN,
		...
		Quizuser user = userService.findByUsername(userName);
